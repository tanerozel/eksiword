...
// if(isMobile){
//     var zoomstyle ={
//         zoom: (33 + (window.innerWidth -  320) / 20)+'%'
//     } 
...
//     "method": "GET",
//     "headers": {
//         "x-rapidapi-host": "alltweets.p.rapidapi.com",
//         "x-rapidapi-key": "1931451516mshef01fd53efdcb84p18ca90jsn9bb57b57aa66"
//     }
// };
 
// var config= {
//     requestLimit:"disabled"
// }

//  var baseUrl = "/api/";
//  var baseUrl = "/tweetwords/api/";
// var app = new Vue({
//     el: '#app',
//     data: {
//       message: '',
...
//     },
//     methods: {
//         setYearText: function (year) {
//             var yearText = year === "all" ? allText : years[year];
//             parseText(yearText);
...
//     allText = "";
//     years = {};
//     userName = d3.select("#accountName").property("value").replace("@","");
//     if(!userName){
//         alert("Please entry a twitter account");
//         return false;
//     } 
    
//     app._data.firstLoad=false;
//     getAllTweet(userName);
//     app._data.years=[];
//     app._data.activeYear="all";
//     app._data.loading = true;
//     app._data.requestCount=0;
//     // gtag('event', 'page_view', {
//     //     page_title: userName,
//     //     page_location: userName
//     // })
// }

// function getAllTweet(userName, lastId) {
//     var url = baseUrl+"get_tweets.php?count=200&tweet_mode=extended&trim_user&screen_name=" + userName;
//     if (lastId)
...
//                         alert(lang.isNotPublicAccount)
//                 }
//                 if(data.errors){
//                     data.errors.forEach(err => {
//                         switch(err.code){
//                             case 34 :
//                                 alert(lang.doesnotexistUser);
//                             break;
//                             default:
//                                  alert(err.message);
//                             break;
...
//                 setYearsElement(years);
//                 return false;
//             }
//             app._data.firstLoad = true;
//             console.log(data);
//             data.forEach(t => {
//                 if (!t.retweeted_status) {
//                     var yearKey = new Date( t.created_at).getFullYear() ;
//                     years[yearKey] = years[yearKey] ? years[yearKey] + " " + t.full_text : t.full_text;
//                     allText = allText + " " + t.full_text;
//                 }
//             });
//             app._data.requestCount++;
//             parseText(allText);
//             lastId = data[data.length - 1].id;
            
//             // if(app._data.requestCount == config.requestLimit){
//             //     app.$data.loading = false;
//             //     setYearsElement(years);
//             //     return false;
//             // }
           
//             getAllTweet(userName, lastId);            
...
// function setYearsElement(years) { 
//     var keys = Object.keys(years);
//     for (var index = 0; index < keys.length; index++) {
//         app._data.years.push({text: keys[index]})
//      }
// }
...
function generate() {
    layout.font(d3.select("#font").property("value")).spiral(d3.select("input[name=spiral]:checked").property("value")),
        ...
        words = [],
        layout.stop().words(tags.slice(0, max = Math.min(tags.length,isMobile ? 500 : d3.select("#max").property("value")))).start()
}
...
function saveSvg(svgData){
    ...
    formData.append("imgBase64", svgData); 
    formData.append("u", userName); 
    var request = new XMLHttpRequest();
    request.open("POST", baseUrl+"save.php");
...
function svg_to_png() {
    var wrapper = document.getElementById("visualisation");
    ...
    img.setAttribute("src", "data:image/svg+xml;base64," + btoa(unescape(encodeURI(svgData))));
    ...
    img.onload = function () {
        ...
        drawStroked("tweetword.com",5, 30);
    ...
    function e() {
        function t(t, n, a) {
            for (var r, o, s, l = ([{
                ...
                (r = h(p += f)) && (o = ~~r[0],
                    s = ~~r[1], !(Math.min(o, s) > d));)
                if (n.x = l + o,
                    n.y = i + s, !(n.x + n.x0 < 0 || n.y + n.y0 < 0 || n.x + n.x1 > e[0] || n.y + n.y1 > e[1]) && (!a || !u(n, t, e[0])) && (!a || c(n, a))) {
...
var unicodePunctuationRe = "!-#%-*,-/:;?@\\[-\\]_{}\xa1\xa7\xab\xb6\xb7\xbb\xbf\u037e\u0387\u055a-\u055f\u0589\u058a\u05be\u05c0\u05c3\u05c6\u05f3\u05f4\u0609\u060a\u060c\u060d\u061b\u061e\u061f\u066a-\u066d\u06d4\u0700-\u070d\u07f7-\u07f9\u0830-\u083e\u085e\u0964\u0965\u0970\u0af0\u0df4\u0e4f\u0e5a\u0e5b\u0f04-\u0f12\u0f14\u0f3a-\u0f3d\u0f85\u0fd0-\u0fd4\u0fd9\u0fda\u104a-\u104f\u10fb\u1360-\u1368\u1400\u166d\u166e\u169b\u169c\u16eb-\u16ed\u1735\u1736\u17d4-\u17d6\u17d8-\u17da\u1800-\u180a\u1944\u1945\u1a1e\u1a1f\u1aa0-\u1aa6\u1aa8-\u1aad\u1b5a-\u1b60\u1bfc-\u1bff\u1c3b-\u1c3f\u1c7e\u1c7f\u1cc0-\u1cc7\u1cd3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205e\u207d\u207e\u208d\u208e\u2329\u232a\u2768-\u2775\u27c5\u27c6\u27e6-\u27ef\u2983-\u2998\u29d8-\u29db\u29fc\u29fd\u2cf9-\u2cfc\u2cfe\u2cff\u2d70\u2e00-\u2e2e\u2e30-\u2e3b\u3001-\u3003\u3008-\u3011\u3014-\u301f\u3030\u303d\u30a0\u30fb\ua4fe\ua4ff\ua60d-\ua60f\ua673\ua67e\ua6f2-\ua6f7\ua874-\ua877\ua8ce\ua8cf\ua8f8-\ua8fa\ua92e\ua92f\ua95f\ua9c1-\ua9cd\ua9de\ua9df\uaa5c-\uaa5f\uaade\uaadf\uaaf0\uaaf1\uabeb\ufd3e\ufd3f\ufe10-\ufe19\ufe30-\ufe52\ufe54-\ufe61\ufe63\ufe68\ufe6a\ufe6b\uff01-\uff03\uff05-\uff0a\uff0c-\uff0f\uff1a\uff1b\uff1f\uff20\uff3b-\uff3d\uff3f\uff5b\uff5d\uff5f-\uff65",
    ...
    echoForm = d3.select("body").append("form").attr("action", "").attr("target", "_blank").attr("method", "POST"),
    ...
    svg = d3.select("#visualisation").append("svg").attr("width", w).attr("height", h).attr("class", "bg-light"),
    background = svg.append("g"),
    vis = svg.append("g").attr("transform", "translate(" + [w >> 1, h >> 1] + ")");
d3.select("#download-svg").on("click", downloadSVG),
    d3.select("#download-png").on("click", downloadPNG);
var form = d3.select("#search-form").on("submit", function () {
    //getdata();
});
form.selectAll("input[type=number]").on("click.refresh", function () {
    ...
    form.selectAll("input[type=radio], #font").on("change", generate);
     var stopWords = /^(çok|tmm|icin|için|cc|var|tam|tüm|bak|ilk|diliyorum|diye|ederiz|mı|ediyorum|he|olarak|û|tamam|14|ederim|ile|veya|ne|ediyor|ki|mi|eden|bile|mu|nEEE|bi|ediyoruz|şu|ama|o|vs|daha|c|bu|şey|gibi|kez|me|da|my|myself|we|rt|bir|da|de|ile|en|ya|ve|us|our|ours|ourselves|you|your|yours|yourself|yourselves|he|him|his|himself|she|her|hers|herself|it|its|itself|they|them|their|theirs|themselves|what|which|who|whom|whose|this|that|these|those|am|is|are|was|were|be|been|being|have|has|had|having|do|does|did|doing|will|would|should|can|could|ought|i'm|you're|he's|she's|it's|we're|they're|i've|you've|we've|they've|i'd|you'd|he'd|she'd|we'd|they'd|i'll|you'll|he'll|she'll|we'll|they'll|isn't|aren't|wasn't|weren't|hasn't|haven't|hadn't|doesn't|don't|didn't|won't|wouldn't|shan't|shouldn't|can't|cannot|couldn't|mustn't|let's|that's|who's|what's|here's|there's|when's|where's|why's|how's|a|an|the|and|but|if|or|because|as|until|while|of|at|by|for|with|about|via|against|between|into|through|during|before|after|above|below|to|from|up|upon|down|in|out|on|off|over|under|again|further|then|once|here|there|when|where|why|how|all|any|both|each|few|more|most|other|some|such|no|nor|not|only|own|same|so|than|too|very|say|says|said|shall|1|2|3|4|5|6|7|8|9|0|10|11|12|A|B|C|D|E|F|G|J|K|L|M|N|O|P|R|İ|Ş|S|T|K|W|X|Y|Z|ö|#|Ş|ı|p|n|j|k)$/,
